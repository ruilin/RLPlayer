...
public class JJMediaSDK {
	...
	public static void init(Context context, JJMediaCallback callback, boolean ifOpenHwDecode,
			String logPath) {
		init(context, callback, ifOpenHwDecode, null, logPath);
	}

	public static void init(Object context, JJMediaCallback callback, boolean ifOpenHwDecode,
	 ...
	 */
	private static native boolean initAvCoreJni(Object context, JJMediaCallback callback,
	...
	public static native boolean glInit(JJVideoView glView, int width, int height);  
