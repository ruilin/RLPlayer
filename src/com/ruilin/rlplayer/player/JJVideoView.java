 ...
 */
public class JJVideoView extends GLSurfaceView implements Renderer, SurfaceTexture.OnFrameAvailableListener {
...
//	private DirectDrawer mDirectDrawer;
	...
	public JJVideoView(Context context, AttributeSet attrs) {
		...
		JJVideoDecoder.getInstance().open(surface, 800, 450);
		surface.release();
	}
...
//		GLES20.glViewport(0, 0, width, height);
		JJMediaSDK.glInit(this, width, height);
		clearColor();
	}
...
//			break;
//		}
		JJMediaSDK.glRender(isHwRending);
	}
	...
	private void openHwDecoder() {
		if (JJVideoDecoder.getInstance().isOpen() || mSurfaceTexture == null) {
			return;
		}
		Surface surface = new Surface(mSurfaceTexture);
		JJVideoDecoder.getInstance().open(surface, 800, 450);
